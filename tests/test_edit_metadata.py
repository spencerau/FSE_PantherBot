...
from ingestion.edit_metadata import edit_course_catalog, grab_course_catalog_metadata, process_raw_course_catalog
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"/Year": "2023", "/ProgramType": "Major", "/Subject": "Computer Engineering", "/Link": "https://example.com/dummy"},
        ),
        (
            "data/raw_major_catalogs/2023_CompSci.pdf",
            {"/Year": "2023", "/ProgramType": "Major", "/Subject": "Computer Science", "/Link": "https://example.com/dummy"},
        ),
        (
            "data/raw_major_catalogs/2024_CompEng.pdf",
            {"/Year": "2024", "/ProgramType": "Major", "/Subject": "Computer Engineering", "/Link": "https://example.com/dummy"},
        ),
        (
            "data/raw_major_catalogs/2024_CompSci.pdf",
            {"/Year": "2024", "/ProgramType": "Major", "/Subject": "Computer Science", "/Link": "https://example.com/dummy"},
        ),
        ...
        (
            ...
            {"/Year": "2022", "/ProgramType": "Minor", "/Subject": "Computer Science", "/Link": "https://example.com/dummy"},
        ),
        (
            "data/raw_minor_catalogs/2023-2024_Undergrad_Analytics.pdf",
            {"/Year": "2023", "/ProgramType": "Minor", "/Subject": "Analytics", "/Link": "https://example.com/dummy"},
        ),
        (
            "data/raw_minor_catalogs/2023-2024_Undergrad_CompEng.pdf",
            {"/Year": "2023", "/ProgramType": "Minor", "/Subject": "Computer Engineering", "/Link": "https://example.com/dummy"},
        ),
    ],
)
